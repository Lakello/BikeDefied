...
public class BikePedalRotator : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        _leftPedal.rotation = Quaternion.LookRotation(_bikeRigidbody.transform.forward, Vector3.up);
        _rightPedal.rotation = Quaternion.LookRotation(_bikeRigidbody.transform.forward, Vector3.up);
    }
}